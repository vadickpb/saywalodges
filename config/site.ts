...
export const WHATSAPP_MESSAGE_EN = "Hi! I'm interested in booking Saywa Lodges in Valle Sagrado, Urubamba. Could you please share availability and rates?";
export const WHATSAPP_MESSAGE_ES = "Hola! Me interesa reservar en Saywa Lodges en el Valle Sagrado, Urubamba. ¿Podrían compartirme disponibilidad y tarifas?";
